;;;; runtime-builtins-string-core-test.lisp — src/runtime-builtins-string-core.lisp.
;;;;
;;;; The foundational string builtins: str_replace, substr, the trim family, explode/implode, the
