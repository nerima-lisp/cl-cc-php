...
;;; Unit tests for runtime-builtins-io-objects.lisp: the PHP object-model,
;;; type-metadata, class/interface/method existence, and reflection helpers.
;;; PHP objects are modeled as plain equal hash-tables carrying a "__class__"
;;; key (and optionally "__parent__"), matching how the sibling php85 object
;;; tests build ad-hoc instances.
(describe
