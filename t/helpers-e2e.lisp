;;;; helpers-e2e.lisp — Shared end-to-end fixture.
;;;;
;;;; %php-run-capture compiles PHP source to the VM, runs it, and returns what it echoed; every
;;;; *-e2e-test.lisp file drives itself through this one function.
