;;;; lexer-test.lisp — src/lexer.lisp and src/lexer-ops.lisp.
;;;;
;;;; Tokenisation of every PHP lexeme class, plus a closing group of smoke checks that the token
;;;; stream this produces reaches the parser intact.
