...
;;; Unit tests for runtime-builtins-io.lisp: system/environment, memory-limit
;;; parsing, INI + error-reporting state, locale helpers, array-pointer builtins,
;;; settype, and the SPL autoload registry. Global-state builtins are exercised
;;; under a save/restore guard so the suite stays order-independent.
(describe
