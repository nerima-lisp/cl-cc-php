;;;; parser-php84-features-test.lisp — src/parser.lisp — PHP 8.0-8.4 language features.
;;;;
;;;; A version-conformance suite rather than the counterpart of a single source file. It covers
;;;; named arguments and first-class callables (src/parser-call-args.lisp), property hooks,
;;;; asymmetric visibility and readonly (src/parser-property-hooks.lisp), Fibers
;;;; (src/runtime-fibers.lisp), array_find/any/all (src/runtime-builtins-array-callable.lisp), and
;;;; intersection types (src/parser-stmt-params.lisp). Anchored on src/parser.lisp because every
;;;; case enters through parse-php-source.
