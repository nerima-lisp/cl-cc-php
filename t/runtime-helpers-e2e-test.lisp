;;;; runtime-helpers-e2e-test.lisp — src/runtime-helpers.lisp and
;;;; src/runtime-helpers-generators.lisp.
;;;;
;;;; End to end: references, foreach by reference, generators, fibers, and closures.
